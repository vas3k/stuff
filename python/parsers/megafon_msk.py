...
def megafon_msk_balance(login, password):
    MEGAFON_API = "https://moscowsg.megafon.ru/WIDGET_INFO/GET_INFO?X_Username=%s&X_Password=%s&CHANNEL=WYANDEX&LANG_ID=1&P_RATE_PLAN_POS=1&P_PAYMENT_POS=2&P_ADD_SERV_POS=4&P_DISCOUNT_POS=3"
